...
<footer class=" dark:bg-gray-700  bg-gray-100 justify-around ">
    <div class="mx-auto w-full max-w-screen-xl " >
      ...
      <div className="hidden md:block ">
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                    <a href="#" classname="text-wrap hover:underline">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                         labore et dolore magna aliqua. Ut enim ad minim veniam</a>
                </li>
                <li class="">
                    <a href="#" class="hover:underline "><strong>Email:</strong> info@jstemplate.net</a>
                </li>
                <li class="">
                    <a href="#" class="hover:underline "><strong>Phone:</strong> 880 123 456 789</a>
                </li>
            </ul>
        </div>
        <div>
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between  justify-center">MetaBlog
